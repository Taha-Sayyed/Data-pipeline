...
def album(data):
    ...
    for row in data['items']:
        ...
        album_element={'album_id':album_id,'name':album_name,'release_date':album_release_date,'total_tracks':album_total_tracks,'url':album_total_tracks}
...
def lambda_handler(event, context):
    s3 = boto3.client('s3')
    Bucket="spotify-etl-pipeline-learning"
